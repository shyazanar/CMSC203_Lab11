...
public abstract class Function {
	...
	/**
	 * Translates f(x) to the display coordinate system. Note that swing and awt
	 * place (0,0) in the upper left, and (xmax, ymax) in the lower right of the
	 ...
	 * @param minY       the minimum f(x) to be displayed, over the extent of the
	 *                   x's
	 * @param maxY       the maximum f(x) to be displayed, over the extent of the
	 *                   x's
