...
public class GraphPanelFX {
	 ...
	 * @param g2         the Graphics2D instance generated by Java library classes
	 *                   and sent as a argument of paintComponent
	 */
	public void drawGraph(double gridWidth2, double gridHeight, GraphicsContext gc) {
		...
		if (functionChoice > 0) {
			...
			for (int i = 1; i < gridWidth2; i++) {
				...
				System.out.println("x0=" + x0 + "  y0=" + graphMgr.getFnValue(functionChoice, x0) + ";  x0Draw="
						+ x0Draw + "  y0Draw=" + y0Draw);
