...
/**
 * The manager deals with the specified problems for optimization, i.e.,
 * selecting the problem that the user wants, setting the x-axis and y-axis
 * extents that the user wants plotted, getting the function value at a
...
public class OptimizerManager implements OptimizerManagerInterface {
	 ...
	 * minimum and maximum values of f(x) for those left-right extents.
	 * 
	...
	public void setExtents(double xLeft, double xRight, double gridWidth2) {
		...
		System.out.println("xLeft = " + xLeft + ";   xRight = " + xRight + "   maxY = " + yTop + ";   minY = " + yBottom
	...
	public String answerString(int choice, double optVal, double x, double y, double z) {
		...
		case 1:
			return "1. " + function1.answerString(optVal, x, y, z) + "\n";
		case 2:
			return "2. " + function2.answerString(optVal, x, y, z) + "\n";
		case 3:
			return "3. " + function3.answerString(optVal, x, y, z) + "\n";
		default:
			return "wrong choice";
		}
	}
